...
ClassBodyC:
    ...
    MethodDecl {$$ = MakeTree(BodyOp, MakeLeaf(DUMMYNode,0), $1);} | ClassBodyB {$$=$1;};
...
Statements_Op4: WhileStatement {$$ = $1;};
/*Assignemnt*/
...
Expre: Expression {$$ = MakeTree(CommaOp, $1,MakeLeaf(DUMMYNode,0) );}|  Expression COMMAnum Expre {$$ = MakeTree(CommaOp,$1,$3);}; 
/*Return rule*/
