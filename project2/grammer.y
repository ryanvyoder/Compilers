...
Statementsop: Statement {$$ = MakeTree(StmtOp,MakeLeaf(DUMMYNode,0),$1);}|Statement SEMInum {$$ = MakeTree(StmtOp,MakeLeaf(DUMMYNode,0),$1);}  |  Statement SEMInum Statementsop  {$$ = MakeTree(StmtOp,$3,$1);};
/*Statement*/
